...
<div class="container">
    ...
    @else --}}
<div>
    <h3>{{$carts->count()}} product dikeranjang anda , segera checkout</h3>
</div>
...
<div class="cart">
        <div class="row">
            <div class="col-lg-3">
            <img class="img-cart" src="{{asset('storage/images/product.jpg')}}" alt=""></div>
            <div class="col-lg-9">
                <div class="top">
...
<div class="totalz">
    <h4 class="total-price">{{number_format($total)}}</h4>
</div>
</div>
