...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="#">O_ncom<span>hideung</span></a>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
        ...
        @endguest
	<div class="content">
		<h1 class="title">Root's Gang</h1>
		<h3>Sepatu/Sandal Berkualitas</h3>
	</div>
	<div class="container">
		<div class="products">
	...
	<footer class="footer-distributed">
		<div class="footer-right">
			<a href="https://www.facebook.com/smkn1ciomas.sch.id/"><i class="fa fa-facebook"></i></a>
